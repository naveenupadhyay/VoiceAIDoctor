              ...
              <div className="space-y-6 scale-in">
                <div>
                  <h1 className="text-4xl font-bold text-white mb-4 bg-gradient-to-r from-blue-200 to-purple-200 bg-clip-text text-transparent">
                     Tanya <p className="text-white/70 text-sm">
                      (AI health assitant in beta) 
                </p>
                  </h1>
                  <p className="text-white/80 text-lg leading-relaxed">
                    Connect with your personal AI health assistant for instant health
                    consultations .Please note AI can only augment and not replace a real doctor.
                    Further this system is just for internal testing and not for public use
                  </p>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl w-full fade-in-up delay-300">
              ...
              <div className="glass-card p-6 text-center">
                ...
                <p className="text-white/70 text-sm">
                  Your health data is protected with enterprise-grade security and only used for improving our models and not shared with external world.
                </p>
              </div>
                   <div className="glass-card p-6 text-center">
                <div className="w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="text-white font-semibold mb-2">
                  In beta testing with Closed User Group.
                </h3>
                <p className="text-white/70 text-sm">
                 The system is currently under testing with a CUG .Unless you have been explicitly invited to the program please do not use this tool.    </p>
              </div>
              <div className="glass-card p-6 text-center">
